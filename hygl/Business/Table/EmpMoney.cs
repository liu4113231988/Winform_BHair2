...
namespace BHair.Business.Table
{
    ...
    public class EmpMoney
    {
        ...
        public bool CheckPass(string uid,string pass)
        {

            string strSql = "select *  from LoginUser  where LoginUserID='" + uid + "' and LoginPassword='" + pass + "'";
            DataTable dtl=new DataTable();
             this.objSQLHelper.ExecuteSql(strSql,out dtl);
        ...
        public void ChangePass(string uid, string oldpass,string newpass)
        {

            string strSql = "update LoginUser set   LoginPassword='" + newpass + "'   where LoginUserID='" + uid + "' and LoginPassword='" + oldpass + "'";
            this.objSQLHelper.ExecuteSql(strSql);
