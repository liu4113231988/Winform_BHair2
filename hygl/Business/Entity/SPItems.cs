...
namespace BHair.Business.BaseData
{
    ...
    public class SPItems
    {
        ...
        public SPItems(int itemid)
        {
            ...
            this.IsTiCheng = int.Parse(objRow["isticheng"].ToString());
        }
        ...
        private int _IsTiCheng;

        /// <summary>获取或设置该商品不计入提成(0否，1是)。</summary>
        public int IsTiCheng
        {
            get { return _IsTiCheng; }
            set { _IsTiCheng = value; }
        }
        ...
        public List<SPItems> SelectList(int type, string text, int status)
        {
            ...
            foreach (DataRow objRow in objDataTable.Rows)
            {
                ...
                objItem.IsTiCheng = int.Parse(objRow["isticheng"].ToString());
